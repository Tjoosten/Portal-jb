...
@section('content')
    <div class="page-header">
        ...
        <div class="page-subtitle">
            Notitie wijzigen voor de verhuur van {{ $lease->tenant->name }}
        </div>
            ...
            <form method="POST" action="{{ route('calendar.notes.store', $lease) }}" class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea id="inputBeschrijving" @input('beschrijving') rows="5" class="form-control @error('beschrijving', 'is-invalid')" placeholder="Extra informatie omtrent de notitie">{{ old('beschrijving') ?? $note->beschrijving }}</textarea>
                        @error('beschrijving')
                    </div>
                </div>
